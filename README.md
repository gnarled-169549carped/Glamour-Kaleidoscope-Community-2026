...
# 🎮 Glamour Kaleidoscope — Community Edition

**Standalone Community Edition of a colorful pattern puzzle game.**
...
Glamour Kaleidoscope is a casual puzzle game built around rotating, color-matching pattern mechanics inspired by kaleidoscope visuals. This Community Edition is a standalone, self-contained package that requires no storefront and includes all content. It is ready to play immediately after installation, with no additional software required.

This build is intended for players who want an offline, standalone copy of Glamour Kaleidoscope for casual puzzle sessions on Windows PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3436280/6d437924994ace4dcc9f52373f43c09abcea6275/ss_6d437924994ace4dcc9f52373f43c09abcea6275.1920x1080.jpg?t=1787126302" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3436280/4bf1af46fbaf46c6c23d9239976e7e26fc7326ca/ss_4bf1af46fbaf46c6c23d9239976e7e26fc7326ca.1920x1080.jpg?t=1787126302" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3436280/1309e3343d788f57a45cddd6a09a349cde208fdc/ss_1309e3343d788f57a45cddd6a09a349cde208fdc.1920x1080.jpg?t=1787126302" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🌀 **Kaleidoscope Puzzle Mechanics** — Rotate and align shifting color patterns to solve each stage.
- 🧩 **Progressive Difficulty** — Puzzle complexity scales gradually across the level set.
- 🎨 **Vibrant Visuals** — Symmetric, brightly colored pattern art in every board.
- 🎯 **Score and Star Objectives** — Earn ratings on each level for replay value.
- 💾 **Local Save System** — Progress is stored offline on the local machine.
- 🖱️ **Simple Controls** — Fully playable with mouse only; no controller required.
- ⏱️ **Short Session Play** — Levels are designed for quick pick-up-and-play sessions.
- 📦 **Self-Contained Package** — Everything needed to run the game is included in one folder.
...
| **RAM** | 2 GB | 4 GB |
| **Graphics** | Intel HD Graphics 3000 or equivalent | Dedicated GPU with 1 GB VRAM |
| **Storage** | 1 GB available space | 1.5 GB available space (SSD) |
| **Additional** | DirectX 9.0c compatible sound card | DirectX 11 compatible audio device |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\GlamourKaleidoscope\Saved`
